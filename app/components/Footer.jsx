    ...
    return (
        <footer className='w-[90%] m-auto dark:text-white'>
            <div className='flex flex-col items-center'>
                ...
                <Link href='/certifications' className='mb-6 py-3.5 px-10 w-max flex items-center justify-between gap-3 bg-linear-to-r from-violet-600 via-fuchsia-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 shadow-lg shadow-fuchsia-500/25 hover:shadow-fuchsia-500/40 text-white font-medium rounded-full cursor-pointer mx-auto transition-all duration-300 hover:scale-105 active:scale-95'>
                    My Certifications
                </Link>
            </div>
