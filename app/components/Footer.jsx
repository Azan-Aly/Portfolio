...
const Footer = () => {
    return (
        <footer className='w-[90%] m-auto dark:text-white'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center my-8 gap-4'>
                <p className='font-Ovo text-sm sm:text-base text-center text-slate-700 dark:text-slate-300'>© 2026 Muhammad Azan Ali. All rights reserved.</p>

                {/* svgs */}
                <div className='flex items-center justify-center gap-5'>
                    <Link href='https://github.com/Azan-Aly' target='_blank' rel='noopener noreferrer' aria-label='GitHub' className='text-gray-600 hover:text-black active:text-black hover:scale-110 active:scale-110 transition-transform dark:text-slate-300 dark:hover:text-white dark:active:text-white'>
                    ...
                    <Link href='https://www.linkedin.com/in/azanaly/' target='_blank' rel='noopener noreferrer' aria-label='LinkedIn' className='text-gray-600 hover:text-[#0A66C2] active:text-[#0A66C2] hover:scale-110 active:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#7ab8ff] dark:active:text-[#7ab8ff]'>
                    ...
                    <Link href='https://facebook.com/mr.azanaly' target='_blank' rel='noopener noreferrer' aria-label='Facebook' className='text-gray-600 hover:text-[#1877F2] active:text-[#1877F2] hover:scale-110 active:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#7ab8ff] dark:active:text-[#7ab8ff]'>
                    ...
                    <Link href='https://www.instagram.com/mr.azan_aly' target='_blank' rel='noopener noreferrer' aria-label='Instagram' className='text-gray-600 hover:text-[#E1306C] active:text-[#E1306C] hover:scale-110 active:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#ff8ab5] dark:active:text-[#ff8ab5]'>
                    ...
                    <Link href='https://youtube.com' target='_blank' rel='noopener noreferrer' aria-label='YouTube' className='text-gray-600 hover:text-[#FF0000] active:text-[#FF0000] hover:scale-110 active:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#ff4f4f] dark:active:text-[#ff4f4f]'>
