...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto min-h-screen pt-22 pb-8 flex flex-col items-center justify-center gap-2 dark:text-white">
      ...
      <div className='flex flex-col sm:flex-row gap-4 items-center justify-center mt-4'>
        <Link href="#contact" className='px-10 py-2 border border-white rounded-full bg-black text-white flex items-center gap-2 transition-transform hover:scale-105 dark:bg-white dark:text-[#11001F]'>contact me <Image src={assets.right_arrow_white} alt='' className='w-4 dark:invert' /> </Link>
        <Link href="/resume.pdf" download className='px-10 py-2 border rounded-full border-gray-500 flex items-center gap-2 text-slate-800 transition-transform hover:scale-105 dark:border-slate-600 dark:text-slate-100' >my resume <Image src={assets.download_icon} alt='' className='w-4 dark:invert' /> </Link>
      </div>

      {/* svgs */}
      <div className='flex items-center justify-center gap-5 mt-6'>
        <Link href='https://github.com/Azan-Aly' target='_blank' rel='noopener noreferrer' aria-label='GitHub' className='text-gray-600 hover:text-black hover:scale-110 transition-transform dark:text-slate-300 dark:hover:text-white'>
        ...
        <Link href='https://www.linkedin.com/in/azanaly/' target='_blank' rel='noopener noreferrer' aria-label='LinkedIn' className='text-gray-600 hover:text-[#0A66C2] hover:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#7ab8ff]'>
        ...
        <Link href='https://facebook.com/mr.azanaly' target='_blank' rel='noopener noreferrer' aria-label='Facebook' className='text-gray-600 hover:text-[#1877F2] hover:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#7ab8ff]'>
        ...
        <Link href='https://www.instagram.com/mr.azan_aly' target='_blank' rel='noopener noreferrer' aria-label='Instagram' className='text-gray-600 hover:text-[#E1306C] hover:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#ff8ab5]'>
        ...
        <Link href='https://youtube.com' target='_blank' rel='noopener noreferrer' aria-label='YouTube' className='text-gray-600 hover:text-[#FF0000] hover:scale-110 transition-transform dark:text-slate-300 dark:hover:text-[#ff4f4f]'>
