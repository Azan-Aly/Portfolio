...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto min-h-screen pt-24 pb-8 flex flex-col items-center justify-center gap-2">
      ...
      <div className='flex items-center justify-center gap-5 mt-6'>
        <Link href='https://github.com' target='_blank' aria-label='GitHub' className='text-gray-600 hover:text-black hover:scale-110 transition-transform'>
        ...
        <Link href='https://linkedin.com' target='_blank' aria-label='LinkedIn' className='text-gray-600 hover:text-[#0A66C2] hover:scale-110 transition-transform'>
        ...
        <Link href='https://facebook.com' target='_blank' aria-label='Facebook' className='text-gray-600 hover:text-[#1877F2] hover:scale-110 transition-transform'>
        ...
        <Link href='https://instagram.com' target='_blank' aria-label='Instagram' className='text-gray-600 hover:text-[#E1306C] hover:scale-110 transition-transform'>
