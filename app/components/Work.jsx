        ...
        {workData.map(({ slug, title, description, bgImage, projectUrl }, index) => (
          ...
          >
            ...
            <div className='absolute inset-x-7 bottom-7'>
              ...
              <h3 className='max-w-lg font-Ovo text-3xl font-bold leading-tight text-slate-800 dark:text-slate-100 group-hover:text-fuchsia-700 group-active:text-fuchsia-700 dark:group-hover:text-fuchsia-300 dark:group-active:text-fuchsia-300 transition-colors md:text-4xl'>{title}</h3>
              ...
              <Link href={`/work/${slug}`} className='relative z-10 mt-5 inline-flex items-center gap-3 rounded-full border border-violet-300 bg-white/80 px-5 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-violet-700 transition-all hover:border-violet-500 active:border-violet-500 hover:bg-violet-50 active:bg-violet-50 hover:shadow-md active:shadow-md hover:shadow-violet-400/30 active:shadow-violet-400/30 dark:border-violet-500/40 dark:bg-[#1b0a2e]/70 dark:text-violet-200 dark:hover:border-fuchsia-400 dark:active:border-fuchsia-400 dark:hover:bg-fuchsia-950/40 dark:active:bg-fuchsia-950/40 dark:hover:shadow-[0_0_15px_rgba(217,70,239,0.4)] dark:active:shadow-[0_0_15px_rgba(217,70,239,0.4)]'>View details <span className='text-base'>→</span></Link>
            </div>
          </article>
        ))}
      </div>
